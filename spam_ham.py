...
## Processing the message stemming and lemming (option)
...
print(process_message(sample_text))


# In[20]:


## Classifier with message (option)
...
pm = process_message('how are you')
